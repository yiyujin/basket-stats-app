        ...
        <div className = "page">
          ...
          <div style = { { display : "flex", flexDirection : "row", gap : "8px" } }>
            ...
            <div style = { { flex : 1 } }>
              ...
              <GameListItem icon = { data.icon?.file.url ? data.icon?.file.url : "" } color = { teamColor } data = { games } team = { data } players = { players } />
              ...
              { players.map( ( item, index) => (
                <div className = "player-list-item-container" style = { { position : "relative", overflow : "hidden", display : "flex", width : "100%", height : "120px", backgroundColor : "var(--black8)", alignItems : "center", padding : "4px", marginBottom : "8px" } }>
